...
const Footer = () => {
    return (
        ...
        <section id="footer" className='bg-[#212529] text-[#fafafacc] py-[4.125rem] overflow-hidden relative'>
            <div className='container mx-auto min-[991px]:px-12'>
                <div className="grid xl:grid-cols-12 min-[991px]:grid-cols-12 grid-cols-12 gap-4">
                    <div className="max-[768px]:col-span-12 min-[768px]:col-span-6 mx-3 max-[768px]:text-center">
                        <p>
                            Copyright © 2023
                    ...
                    <div className="max-[768px]:col-span-12 min-[768px]:col-span-6 mx-3 flex justify-center min-[768px]:justify-end">
